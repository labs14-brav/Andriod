...
class ActiveCasesActivity : AppCompatActivity() {
    ...
    private fun getActiveCases(token: String) {

        val service = RetroInstance().service(token)
        val call = service.getActiveCases(sharedPreference.getUserId("userId"))
